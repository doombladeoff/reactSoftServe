...
function EditWord({ route, navigation }) {
    const [image, setImage] = useState(() => route.params.wordData.image);
    ...
    function onSave() {
        image ? dispatch(wordsLearningActions.updateWord({
            ...wordData,
            image
            ...
            {image ? (
                <View style={{ justifyContent: 'center', alignItems: 'center', padding: 15 }}>
                    <Pressable onPress={pickImage}>
                        <ImageViewer selectedImage={image} width={150} height={150}/>
                    </Pressable>
                </View>
            ) : (
                <View style={{ justifyContent: 'center', alignItems: 'center', padding: 15 }}>
                    <Pressable onPress={pickImage} style={{ justifyContent: 'center', alignItems: 'center' }}>
                        <ImageViewer
                            ...
                            height={150}
                        />
                        <Text style={{ color: colors.fontMain }}>No image taken yet.</Text>
                    </Pressable>
                </View>
            )}
